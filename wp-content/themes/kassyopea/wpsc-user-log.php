	...
	<div class="hentry">
		<div class="wrap">
			<div class="user-profile-links">
				<a href="<?php echo get_option( 'user_account_url' ); ?>"><?php _e('Purchase History',TEXTDOMAIN); ?></a> |
				<a href="<?php echo get_option( 'user_account_url' ) . $separator . "edit_profile=true"; ?>"><?php _e('Your Details',TEXTDOMAIN); ?></a> |
				<a href="<?php echo get_option( 'user_account_url' ) . $separator . "downloads=true"; ?>"><?php _e('Your Downloads',TEXTDOMAIN); ?></a>
					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<input type="submit" value="<?php _e( 'Save Profile', TEXTDOMAIN ); ?>" name="submit" />
							</td>
						</tr>
					</table>
				</form>
			...
			<?php elseif ( is_wpsc_downloads_page() ) : ?>
				...
				<?php if ( wpsc_has_downloads() ) : ?>
						...
						<table class="logdisplay">
							<tr>
								<th><?php _e( 'File Names', TEXTDOMAIN ); ?> </th>
								<th><?php _e( 'Downloads Left', TEXTDOMAIN ); ?> </th>
				...
				<?php else : ?>
					...
					<?php _e( 'You have not purchased any downloadable products yet.', TEXTDOMAIN ); ?>
			...
			<?php else : ?>
				...
				<?php if ( is_user_logged_in() ) : ?>
					...
					<?php if ( wpsc_has_purchases() ) : ?>
						...
						<?php if ( wpsc_has_purchases_this_month() ) : ?>
								...
								<tr class="toprow">
									<td><strong><?php _e( 'Status', TEXTDOMAIN ); ?></strong></td>
									<td><strong><?php _e( 'Date', TEXTDOMAIN ); ?></strong></td>
									<td><strong><?php _e( 'Price', TEXTDOMAIN ); ?></strong></td>
		
									<?php if ( get_option( 'payment_method' ) == 2 ) : ?>
		
										<td><strong><?php _e( 'Payment Method', TEXTDOMAIN ); ?></strong></td>
						...
						<?php else : ?>
								...
								<tr>
									<td colspan="<?php echo $col_count; ?>">
										...
										<?php _e( 'No transactions for this month.', TEXTDOMAIN ); ?>
					...
					<?php else : ?>
						...
						<table>
							<tr>
								<td><?php _e( 'There have not been any purchases yet.', TEXTDOMAIN ); ?></td>
							</tr>
						</table>
				...
				<?php else : ?>
					...
					<?php _e( 'You must be logged in to use this page. Please use the form below to login to your account.', TEXTDOMAIN ); ?>
		
					<form name="loginform" id="loginform" action="<?php bloginfo('url'); ?>/wp-login.php" method="post">
						<p>
							<label><?php _e( 'Username:', TEXTDOMAIN ); ?><br /><input type="text" name="log" id="log" value="" size="20" tabindex="1" /></label>
						</p>
		
						<p>
							<label><?php _e( 'Password:', TEXTDOMAIN ); ?><br /><input type="password" name="pwd" id="pwd" value="" size="20" tabindex="2" /></label>
						</p>
						...
						<p class="submit">
							<input type="submit" name="submit" id="submit" value="<?php _e( 'Login &raquo;', TEXTDOMAIN ); ?>" tabindex="4" />
